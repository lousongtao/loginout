...
public class UpmsUserController extends BaseController {
    ...
    public String organization(@PathVariable("id") int id, ModelMap modelMap) {
        // 所有组织
        List<UpmsOrganization> upmsOrganizations = upmsOrganizationService
            .selectByExample(new UpmsOrganizationExample());
        // 用户拥有组织
    ...
    public Object delete(@PathVariable("ids") String ids) {
        ...
        if (count > 0) {
            ...
            upmsUserPermissionService.deleteByExample(example);
            LOGGER.info("删除用户成功,同时清除用户额外权限");
        }
