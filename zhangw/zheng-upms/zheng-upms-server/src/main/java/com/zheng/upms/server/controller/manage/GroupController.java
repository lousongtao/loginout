...
import com.zheng.upms.dao.vo.McGroupUser;
...
public class GroupController extends BaseController {
    ...
    public Object getGroupUser() {
        ...
        return new UpmsResult(UpmsResultConstant.SUCCESS, groupUsers);
    }
    ...
    public Object create(McGroup mcGroup) {
        ...
        if (create == 0) {
            return new UpmsResult(UpmsResultConstant.FAILED, "组名已存在,请更换！");
        }
    ...
    public Object delete(@PathVariable("id") Integer id) {
        ...
        if (count == 0) {
            return new UpmsResult(UpmsResultConstant.FAILED, "组内有员工,请先解除绑定");
        } else {
