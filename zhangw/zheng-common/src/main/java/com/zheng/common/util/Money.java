...
public class Money implements Serializable, Comparable {
     ...
     */
    private static final int[]                        centFactors               = new int[] { 1, 10,
                                                                                              100,
                                                                                              1000 };
    ...
    *//**
      * 根据地区得到显示用的货币单位
      * 如Locale是zh_CN，返回“元”，如Locale是zh_HK返回“圓”
      *
      * @param e 需要得到的地区
      * @return 显示用的单位，比如“元”，“美元”
      *//*
